...
namespace sr
{
  ...
  public class SearchItemInstances : SearchItem
  {
    ...
    bool inSamePrefab(UnityEngine.Object objA, UnityEngine.Object objB)
    {
      UnityEngine.Object aPrefab = PrefabUtility.GetPrefabObject(objA);
      UnityEngine.Object bPrefab = PrefabUtility.GetPrefabObject(objB);
